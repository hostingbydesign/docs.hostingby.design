...
```bash main
curl -sL https://docs.hostingby.design/static/scripts/1.sh -o ~/1.sh && chmod +x ~/1.sh
```
...
```bash main
curl -sL https://docs.hostingby.design/static/scripts/2.sh -o ~/2.sh && chmod +x ~/2.sh
```
