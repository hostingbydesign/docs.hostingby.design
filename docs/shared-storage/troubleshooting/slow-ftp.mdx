...
If this does not work, we offer a FTP Bouncer service, which will send the data from our servers over high capacity links to a server which is located closer to you. You can find the description on how to use our bouncer servers here: https://panel.hostingby.design/index.php?rp=/knowledgebase/33/How-to-use-our-bouncer-servers.html
