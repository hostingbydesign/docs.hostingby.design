...
- Username: `<username>@X.d.itsby.design` (Where X refers to the server you are on, fx 8.d if you are on that server, you can find the server in your welcome email and inside the clientarea)
