---
id: leaseweb-reinstall
title: "Leaseweb Reinstall"
sidebar_label: "Leaseweb Reinstall"
---
...
```
:::tip Tip
It's best to use the default partitions and just adjust the sizes of them to make the installs work. For example removing the /boot partition can cause the installer to not function properly.
:::
