...
```plaintext main
box install thelounge
```
Installation will take a few moments. Once it's done, you'll receive a notice that the installation is complete and the installer will let you know where you can access the application. For example: `https://<server>.<network>.itsby.design/<user>/thelounge`.
