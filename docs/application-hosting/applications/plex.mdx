...
:::tip Upgrading
Upgrading your PLEX instance is a simple process, login to the webui/dashboard we provide for your service, find the "Application management" section in the page you are presented with, from there simply click "Restart" next to plex, that will restart the app and also check for updates, please note that we are usually 2-3 days behind on updates!
:::
